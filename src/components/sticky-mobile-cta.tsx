...
export function StickyMobileCTA({
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-lg rounded-2xl border border-white/20 bg-slate-900/95 px-4 py-3 shadow-2xl backdrop-blur-md">
        <button
          type="button"
          onClick={handleClick}
          className="cta-glow btn-ripple flex min-h-[48px] w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-500 to-emerald-600 px-6 py-3 text-base font-semibold text-white shadow-lg transition hover:from-emerald-600 hover:to-emerald-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 active:scale-[0.98]"
        >
          <svg
            className="h-5 w-5"
            fill="none"
