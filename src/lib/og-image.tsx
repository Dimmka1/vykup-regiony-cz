    ...
    (
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: "14px" }}>
          ...
          <h1 style={{ fontSize: 64, lineHeight: 1.1, margin: 0, maxWidth: "85%" }}>{region.h1}</h1>
        </div>

        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            <span style={{ fontSize: 30, fontWeight: 700 }}>{region.locative}</span>
            <span style={{ fontSize: 24, opacity: 0.9 }}>Nezávazná nabídka do 24 hodin</span>
          </div>
          <span
            style={{
